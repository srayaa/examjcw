...
<html>
	...
	<body>
					...
					<div class="col-md-12">
						<div class="flexslider">
							<div class="flex-caption">
								<!-- Left column -->
								<div class="col-l">
									<p style="text-indent:2em;">鹤壁市纪委监委内部学习平台是国内首款一款基于JAVA与MYSQL开发的网络考试系统。它可以稳定、顺畅的运行在Windows与Linux平台上。您可以通过它快捷方便的创建试题和题库，发布试卷，组织考试，系统自动批改。高度的可配置性和灵活性使得它可以被应用于很多领域。</p>
		...
		src="resources/js/jquery/jquery-1.9.0.min.js"></script><script>$(".nav li:first").css("display","none");$("footer").prev().css("margin-bottom","60px");</script>
		<!-- Bootstrap JS -->
		<script type="text/javascript"
