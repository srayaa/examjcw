...
<html>
	<head>
		...
		<title>鹤壁市纪委监委内部学习平台 注册成功</title>
	...
	<body>
		...
		<!-- Javascript files -->
		<!-- jQuery -->
		<script type="text/javascript" src="resources/js/jquery/jquery-1.9.0.min.js"></script><script>$(".nav li:first").css("display","none");$("footer").prev().css("margin-bottom","60px");</script>
		<!-- Bootstrap JS -->
